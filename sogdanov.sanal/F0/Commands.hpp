...
namespace sogdanov {
  ...
  void dropDict(std::istream& in, std::ostream& out, HashTable< std::string, Dictionary >& dicts);
  void addWord(std::istream& in, std::ostream& out, HashTable< std::string, Dictionary >& dicts);
  void removeWord(std::istream& in, std::ostream& out, HashTable< std::string, Dictionary >& dicts);
  ...
  void mergeDicts(std::istream& in, std::ostream& out, HashTable< std::string, Dictionary >& dicts);
  ...
  void listDicts(std::istream& in, std::ostream& out, HashTable< std::string, Dictionary >& dicts);
  ...
  void complementDicts(std::istream& in, std::ostream& out, HashTable< std::string, Dictionary >& dicts);
